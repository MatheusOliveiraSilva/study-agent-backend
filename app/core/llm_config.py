...
class LLMConfig:
    ...
    def get_llm(self):
        ...
        if self.provider == "azure":
            ...
            return self.get_bedrock_llm(**self.kwargs)
        else:
    ...
    def get_azure_llm(self, **kwargs):
        ...
        kwargs = self.manage_azure_kwargs(kwargs)
    ...
    def manage_azure_kwargs(self, kwargs):
        """
        Manages the Azure kwargs.
        ...
        This function is used to handle some cases, like:
            ...
            - the reasoning_effort (only supported by o1 and o3 family models, se we pop it from kwargs if are not using o1 or o3)
